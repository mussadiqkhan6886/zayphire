  ...
  return (
    <header className={`px-5 md:px-8 py-7 flex justify-between w-full fixed z-10 top-0 ${view ? "text-black" : "text-white"}`}>
      <div className='flex gap-10'>
        ...
        <Link href="/">
        <Image fetchPriority='high' priority={true} src={`${view  ? "/zayphireBlack.png" : "/zayphireGray.png"}`} alt="zayphire image logo main hero" width={200} className='w-[120px] md:w-full' height={100} />
        </Link>
      </div>
